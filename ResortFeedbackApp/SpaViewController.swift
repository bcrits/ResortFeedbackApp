...
class SpaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        createForm(view: form1, attributeKey: "spaQ1", vc: tabbarVC)
        createForm(view: form2, attributeKey: "spaQ2", vc: tabbarVC)
        createForm(view: form3, attributeKey: "spaQ3", vc: tabbarVC)
        createForm(view: form4, attributeKey: "spaQ4", vc: tabbarVC)
        createForm(view: form5, attributeKey: "spaQ5", vc: tabbarVC)
    }
